 ...
 *
 * The bars themselves are decorative and stay `aria-hidden`; the wait is
 * announced by a live `role="status"` beside them. Pass `label={null}` where
 * the skeleton is a reference rather than a real wait.
 */
